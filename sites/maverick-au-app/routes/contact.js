...
router.post('/', async (req, res, next) => {
  try {
    ...
    await transporter.sendMail({
      from: `"Maverick Website" <${process.env.SMTP_USER}>`,
      to: process.env.CONTACT_TO || 'info@maverickconsultingsolutions.com',
      replyTo: email,
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          ...
          <p style="margin-top:24px;font-size:12px;color:#999">Sent via maverickconsultingsolutions.com contact form</p>
        </div>
      `,
    });
